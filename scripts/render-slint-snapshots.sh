...
digital_screens=(hub systems games games-list settings settings-page about context letters dialog saver)
crt_screens=(crt-hub crt-systems crt-games crt-settings calibration)
