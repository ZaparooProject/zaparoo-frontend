...
fn sync_with_state(primary: &App, crt: &App, state: &mut SyncState) {
    ...
    // page shape follows the primary. Per-head page re-slicing is not
    // implemented.
    ...
    copy_properties!(source, target;
        ...
        get_media_missing => set_media_missing,
        get_image_index => set_image_index,
        get_image_count => set_image_count,
        get_scroll_position => set_scroll_position,
    ...
    copy_properties!(source, target;
        ...
        get_card_write_key => set_card_write_key,
        get_qr_open => set_qr_open,
        get_qr_documentation => set_qr_documentation,
