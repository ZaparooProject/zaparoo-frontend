...
/// Classifies the notifications the status line surfaces, with their
/// single plain-text argument.
...
/// Turn the task tiers on. Called as soon as the media status is seeded.
