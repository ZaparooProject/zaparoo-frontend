...
#![allow(
    dead_code,
    reason = "the complete v4 wire vocabulary; any one build consumes only part of it"
)]
...
// The full disposition set a receipt can carry; the presenter only ever
// branches on `DISPOSITION_ACCEPTED`.
