//! Minimal scrolling for Slint's bounded list window. Selection remains
//! stationary until it reaches a viewport edge, rather than staying
//! centered while the list moves under it.
