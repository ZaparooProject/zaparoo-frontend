...
// startup: the kernel-backed resource lease Core reads to know a
// frontend is on screen, and the fire-and-forget service start so a
// fresh boot has a Core to talk to.
