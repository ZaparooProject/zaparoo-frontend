...
// global. The rules live in `zaparoo_app::palette`, pinned to its golden
// fixture; this is the adapter that turns `Rgb16` values into Slint
// colors and binds them to the theme's roles.
