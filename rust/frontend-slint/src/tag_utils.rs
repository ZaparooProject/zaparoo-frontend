...
//
// Copied verbatim from rust/frontend/src/models/tag_utils.rs (pure
// Rust, no Qt): the compact-token + sibling-diff pipeline behind the
// locked inline-metadata design. If the migration proceeds, this
// module moves to a shared crate instead of living twice.
